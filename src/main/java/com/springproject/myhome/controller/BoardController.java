...
import com.springproject.myhome.service.BoardService;
...
public class BoardController {
    ...
    @PostMapping("/form")
    public String postForm(@Valid Board board, BindingResult bindingResult, Authentication authentication) { //validation으로 인해 인자를 재지정했음
